...
function AmazonMws(environmentKey, accessSecret, version) {
    if (!(this instanceof AmazonMws)) {
        return new AmazonMws(environmentKey, accessSecret, version);
    }
...
AmazonMws.prototype = {
    ...
    setTimeout: function (timeout) {
        this._setApiField(
          'timeout',
          timeout === null ? AmazonMws.DEFAULT_TIMEOUT : timeout
        );
    },
